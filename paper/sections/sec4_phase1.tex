...
the coefficient $A$.  In the regime of interest for DPPU, $A$ is expected
...
the semiclassical regime relevant to DPPU the equal–radius configuration
...
deferred to Appendix~\ref{app:phase1-details}.)
...
are essential for the DPPU picture therefore cannot come from the TEGR
